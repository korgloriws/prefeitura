...
def preparar_valor_monetario(valor):
    if pd.isna(valor) or str(valor).strip() in ['', '-']:
        ...
        return 'R$ ' + str(valor).strip().replace('.', ',')
...
def escolher_colunas_balancete(conta, natureza_final):
    ...
    excecoes = {
         ...
         "123810105000000", "123810101000000", "121119904000000", "121119905000000", 
         "121219903000000", "123810199000000", "123810102000000", "123810205000000",
         "521120200000000", "521120101000000", "521129900000000", "113910402000000",
         "121119999000000", "123810104000000", "521120300000000", "521120400000000", 
         "522130900000000", "123810103000000",
         ...
         "227210403000000", "227210404000000", "227220101000000", "227220203000000", 
         "621310100000000", "621320000000000", "62133000000000", "621340000000000", 
         "621360000000000", "621390000000000", "621330000000000", "227210303000000",
         "227210103000000"
    }
    

    CONTAS_HIBRIDAS = {
       "227210500000000","234100000000000","234110000000000","234120000000000","234130000000000",
       "234140000000000","234150000000000","234200000000000","234210000000000","234220000000000",
       "234230000000000","234240000000000","234250000000000","237000000000000","237100000000000",
       "237110000000000","237110100000000","237110200000000","237110300000000","237110301000000",
       "237110302000000","237110400000000","237120000000000","237120100000000","237120200000000",
       "237120300000000","237120400000000","237130000000000","237130100000000","237130200000000",
       "237130300000000","237130400000000","237140000000000","237140100000000","237140200000000",
       "237140300000000","237140400000000","237150000000000","237150100000000","237150200000000",
       "237150300000000","237150400000000","237200000000000","237210000000000","237210100000000",
       "237210101000000","237210200000000","237210201000000","237210202000000","237210300000000",
       "237210400000000","237210500000000","237210600000000","237220000000000","237220100000000",
       "237220200000000","237220300000000","237220400000000","237220500000000","237220600000000",
       "237230000000000","237230100000000","237230200000000","237230300000000","237230400000000",
       "237230500000000","237230600000000","237240000000000","237240100000000","237240200000000",
       "237240300000000","237240400000000","237240500000000","237240600000000","237250000000000",
       "237250100000000","237250200000000","237250300000000","237250400000000","237250500000000",
       "237250600000000","511200000000000","522139900000000","621100000000000","622800000000000",
       "821110000000000","821110100000000","821110200000000","821119900000000"
    }
    

    if conta in CONTAS_HIBRIDAS:
        if natureza_final == 'D':
...
def comparar_valores(conta, matriz_df, balancete_df, discrepancias, registros_corretos, contas_tipo_5):
    ...
    if row_matriz is not None and 'Natureza Final' in row_matriz and pd.notna(row_matriz['Natureza Final']):
        natureza_final = str(row_matriz['Natureza Final']).strip()
    ...
    for col_matriz, col_balancete in zip(colunas_matriz, colunas_balancete):
        ...
        if row_matriz is not None and col_matriz in row_matriz:
            valor_matriz = converter_valor_monetario(preparar_valor_monetario(row_matriz[col_matriz]))
        if row_balancete is not None and col_balancete in row_balancete:
            valor_balancete = converter_valor_monetario(preparar_valor_monetario(row_balancete[col_balancete]))
...
def main():
    ...
    if st.button('Comparar Arquivos'):
        if matriz_file is not None and balancete_file is not None and plano_file is not None:
            ...
            todas_contas = contas_tipo_5 | contas_matriz | contas_balancete
            contas_nao_encontradas_df = pd.DataFrame({
                'Conta': list(todas_contas),
                'Presente no Plano de Contas': ['Sim' if conta in contas_tipo_5 else 'Não' for conta in todas_contas],
                'Presente na Matriz': ['Sim' if conta in contas_matriz else 'Não' for conta in todas_contas],
                'Presente no Balancete': ['Sim' if conta in contas_balancete else 'Não' for conta in todas_contas]
            })

            filename = 'relatorio_comparacao.xlsx'
