...
def verificar_contas_nao_encontradas(contas_plano, contas_matriz_balancete):
    return list(contas_plano - contas_matriz_balancete)

def escolher_colunas_balancete(conta):
    excecoes_1 = [
        "112910101000000", "112910102000000", "112910104000000", "113919900000000",
        "121119904000000","121119905000000", "121219903000000", "123810199000000", "521120200000000","521120101000000","521129900000000",
        "521120300000000", "521120400000000", "522130900000000"
    ]
    excecoes_2 = [
        ...
        "227210403000000", "227210404000000","2272101030000000","2272201010000000","227220203000000", "621310100000000", "621320000000000",
        "62133000000000", "621340000000000", "621360000000000", "621390000000000"
    ]
    
    if conta in excecoes_1 or conta in excecoes_2:
...
def main():
    ...
    if st.button('Comparar Arquivos'):
        if matriz_file is not None and balancete_file is not None and plano_file is not None:
            ...
            contas_balancete = set(balancete_df['cod_contabil'])
