...
def process_998(file_998):
    ...
    print("DataFrame 998:")
    print(df_998.head())  # Verifica a estrutura do DataFrame
    return df_998

def process_3500(file_3500):
    df_3500 = pd.read_excel(file_3500, dtype={'fonte': str})
    print("DataFrame 3500:")
    print(df_3500.head())  # Verifica a estrutura do DataFrame
    return df_3500
...
def update_fundos_municipais(file_fundos, df_998, df_3500, aba):
    ...
    for mapping in mappings:
        ...
        ws.cell(row=row_idx, column=3, value=value)  # Preenchendo na coluna C
    
    print(f"Salvando dados no arquivo: {file_fundos}")
    wb.save(file_fundos)
...
def main():
    ...
    if st.button("Preencher Dados"):
        if file_998 and file_3500 and file_fundos:
            ...
            update_fundos_municipais(file_fundos, df_998, df_3500, aba)
