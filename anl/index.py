...
def comparar_arquivos(relatorio_path, anl_path, output_path):
   
    relatorio = pd.read_csv(relatorio_path, encoding='iso-8859-1', delimiter=';', on_bad_lines='skip')
    anl = pd.read_csv(anl_path, encoding='iso-8859-1', delimiter=';', on_bad_lines='skip')
...
relatorio_path = 'Relatório 1157 - Anulação de empenhos Março-2024.csv'
anl_path = 'ANL Março-2024 (1).csv'
output_path = 'comparacao_diferencas.xlsx'


diferencas = comparar_arquivos(relatorio_path, anl_path, output_path)

print("Comparação realizada com sucesso. Verifique o arquivo Excel gerado.")
