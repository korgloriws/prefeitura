...
lqd_df = pd.read_csv('LQD Dez-23.csv', sep=';', dtype=str, encoding='ISO-8859-1')
...
df_1162 = pd.read_csv('Rel. 1162 Liquidações dez-23.csv', sep=';', dtype=str, encoding='ISO-8859-1')
...
restos_pagar_df = pd.read_csv('restos a pagar não processados dez-23.csv', sep=';', dtype=str, encoding='ISO-8859-1')
...
with pd.ExcelWriter('relatorio_diferencas.xlsx', engine='openpyxl') as writer:
