...
def process_rpp_rpnp(file_path):
    df = pd.read_csv(file_path, encoding='latin1', delimiter=';')
    df['fonte'] = df['fonte'].astype(str)
    df_filtrado = df[df['fonte'].isin(['21540770', '21540000'])]
...
caminho_qgr = '966.csv'
caminho_ded_361 = '12361.csv'
caminho_ded_365 = '12365.csv'
caminho_rpp_1619 = ''
caminho_rpnp_1619 = ''
caminho_fundeb = 'FUNDEB_v2.xlsx'

qgr_data = process_qgr(caminho_qgr) if caminho_qgr else None
ded_361_data = process_ded(caminho_ded_361) if caminho_ded_361 else None
ded_365_data = process_ded(caminho_ded_365) if caminho_ded_365 else None
rpp_1619_data = process_rpp_rpnp(caminho_rpp_1619) if caminho_rpp_1619 else None
rpnp_1619_data = process_rpp_rpnp(caminho_rpnp_1619) if caminho_rpnp_1619 else None

fill_fundeb(caminho_fundeb, qgr_data, ded_361_data, ded_365_data, rpp_1619_data, rpnp_1619_data)
