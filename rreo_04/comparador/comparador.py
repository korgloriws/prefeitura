...
def comparar_intervalo(sheet1, sheet2, inicio='A1', fim='F234'):
    discrepancias = []
...
def gerar_relatorio_discrepancias(discrepancias, caminho_salvar):
    ...
    with xw.App(visible=False) as app:
        wb = app.books.add()
        sheet = wb.sheets[0]
        sheet.range('A1').value = ['Célula', 'siconfi', 'integrador']
...
def main():
    st.title('Comparador RREO Anexo 04')
    ...
    if st.button('Comparar Arquivos'):
        if arquivo_xls_1 and arquivo_xls_2:
            ...
            try:
                ...
                sheet1 = wb1.sheets['RREO-Anexo 04']
                sheet2 = wb2.sheets['RREO-Anexo 04']
                ...
                if discrepancias:
                    ...
                    for celula, valor1, valor2 in discrepancias:
                        st.write(f'{celula}: siconfi = {valor1}, integrador = {valor2}')
